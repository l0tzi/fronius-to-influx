...
class Fronius2Influx(object):
    ...
    def translate_response(self):
        ...
        if collection == 'CommonInverterData':
            ...
            return {
                        'Current_AC_Phase_1': self.float_or_zero(self.data["Body"]["Data"]["Current_AC_Phase_1"]),
                        'Current_AC_Phase_2': self.float_or_zero(self.data["Body"]["Data"]["Current_AC_Phase_2"]),
                        'Current_AC_Phase_3': self.float_or_zero(self.data["Body"]["Data"]["Current_AC_Phase_3"]),
                        ...
                        'EnergyReactive_VArAC_Sum_Consumed': self.float_or_zero(self.data["Body"]["Data"]["EnergyReactive_VArAC_Sum_Consumed"]),
                        'EnergyReactive_VArAC_Sum_Produced': self.float_or_zero(self.data["Body"]["Data"]["EnergyReactive_VArAC_Sum_Produced"]),
                        'EnergyReal_WAC_Minus_Absolute': self.float_or_zero(self.data["Body"]["Data"]["EnergyReal_WAC_Minus_Absolute"]),
                        'EnergyReal_WAC_Plus_Absolute': self.float_or_zero(self.data["Body"]["Data"]["EnergyReal_WAC_Plus_Absolute"]),
                        'EnergyReal_WAC_Sum_Consumed': self.float_or_zero(self.data["Body"]["Data"]["EnergyReal_WAC_Sum_Consumed"]),
                        'EnergyReal_WAC_Sum_Produced': self.float_or_zero(self.data["Body"]["Data"]["EnergyReal_WAC_Sum_Produced"]),
                        'Frequency_Phase_Average': self.float_or_zero(self.data["Body"]["Data"]["Frequency_Phase_Average"]),
                        'Meter_Location_Current': self.data["Body"]["Data"]["Meter_Location_Current"],
                        'PowerApparent_S_Phase_1': self.float_or_zero(self.data["Body"]["Data"]["PowerApparent_S_Phase_1"]),
                        'PowerApparent_S_Phase_2': self.float_or_zero(self.data["Body"]["Data"]["PowerApparent_S_Phase_2"]),
                        'PowerApparent_S_Phase_3': self.float_or_zero(self.data["Body"]["Data"]["PowerApparent_S_Phase_3"]),
                        'PowerApparent_S_Sum': self.float_or_zero(self.data["Body"]["Data"]["PowerApparent_S_Sum"]),
                        'PowerFactor_Phase_1': self.float_or_zero(self.data["Body"]["Data"]["PowerFactor_Phase_1"]),
                        'PowerFactor_Phase_2': self.float_or_zero(self.data["Body"]["Data"]["PowerFactor_Phase_2"]),
                        'PowerFactor_Phase_3': self.float_or_zero(self.data["Body"]["Data"]["PowerFactor_Phase_3"]),
                        'PowerFactor_Sum': self.float_or_zero(self.data["Body"]["Data"]["PowerFactor_Sum"]),
                        'PowerReactive_Q_Phase_1': self.float_or_zero(self.data["Body"]["Data"]["PowerReactive_Q_Phase_1"]),
                        'PowerReactive_Q_Phase_2': self.float_or_zero(self.data["Body"]["Data"]["PowerReactive_Q_Phase_2"]),
                        'PowerReactive_Q_Phase_3': self.float_or_zero(self.data["Body"]["Data"]["PowerReactive_Q_Phase_3"]),
                        'PowerReactive_Q_Sum': self.float_or_zero(self.data["Body"]["Data"]["PowerReactive_Q_Sum"]),
                        'PowerReal_P_Phase_1': self.float_or_zero(self.data["Body"]["Data"]["PowerReal_P_Phase_1"]),
                        'PowerReal_P_Phase_2': self.float_or_zero(self.data["Body"]["Data"]["PowerReal_P_Phase_2"]),
                        'PowerReal_P_Phase_3':self.float_or_zero( self.data["Body"]["Data"]["PowerReal_P_Phase_3"]),
                        'PowerReal_P_Sum': self.float_or_zero((self.data["Body"]["Data"]["PowerReal_P_Sum"])),
                        'MeterTimeStamp': self.data["Body"]["Data"]["TimeStamp"],
                        'MeterVisible': self.data["Body"]["Data"]["Visible"],
                        'Voltage_AC_PhaseToPhase_12': self.float_or_zero(self.data["Body"]["Data"]["Voltage_AC_PhaseToPhase_12"]),
                        'Voltage_AC_PhaseToPhase_23': self.float_or_zero(self.data["Body"]["Data"]["Voltage_AC_PhaseToPhase_23"]),
                        'Voltage_AC_PhaseToPhase_31': self.float_or_zero(self.data["Body"]["Data"]["Voltage_AC_PhaseToPhase_31"]),
                        'Voltage_AC_Phase_1': self.float_or_zero(self.data["Body"]["Data"]["Voltage_AC_Phase_1"]),
                        'Voltage_AC_Phase_2': self.float_or_zero(self.data["Body"]["Data"]["Voltage_AC_Phase_2"]),
                        'Voltage_AC_Phase_3': self.float_or_zero(self.data["Body"]["Data"]["Voltage_AC_Phase_3"]),
                    }
        elif collection == 'LoggerInfo':
            keyname = 'LoggerInfo'
            return {
                        'CO2Factor': self.float_or_zero(self.data['Body'][keyname]['CO2Factor']),
                        'CO2Unit': self.data['Body'][keyname]['CO2Unit'],
                        'CashCurrency': self.data['Body'][keyname]['CashCurrency'],
                        'CashFactor': self.float_or_zero(self.data['Body'][keyname]['CashFactor']),
                        'DefaultLanguage': self.data['Body'][keyname]['DefaultLanguage'],
                        'DeliveryFactor': self.float_or_zero(self.data['Body'][keyname]['DeliveryFactor']),
        ...
        try:
            while(True):
                try:
                    ...
                    current_production = self.float_or_zero(max(collected_data['PAC'], 0))
                    current_fedin = self.float_or_zero(max((collected_data['PowerReal_P_Sum'] * -1),0))
                    current_draw = self.float_or_zero(max(collected_data['PowerReal_P_Sum'], 0))
                    current_consumption = self.float_or_zero((current_production - current_fedin + current_draw))
